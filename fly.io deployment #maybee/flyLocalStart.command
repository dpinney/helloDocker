...
services:
    webapp:
        ...
        container_name: docker_compose_test
        ports:
            - "5000:80"
END
)
...
echo "$COMPOSE_FILE" | docker compose -p compose_test -f /dev/stdin up -d
...
trap "docker stop docker_compose_test" SIGKILL SIGINT SIGTERM
...
docker stop docker_compose_test